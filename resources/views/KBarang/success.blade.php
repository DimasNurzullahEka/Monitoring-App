@extends('KBarang.template.L_success')
            ...
            <div class="row justify-content-center">
                <div class="text-center col-7">
                    <h5 class="text-center purple-text">
                        Kamu Telah berhasil Menambahkan data KodeBarang!!<a href="{{route('kode.index')}}" class="text-underline">Kembali Ke halaman Kode Barang</a>
                    </h5>
                </div>
            </div>
        </div>
