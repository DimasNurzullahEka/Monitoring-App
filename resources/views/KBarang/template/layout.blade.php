...
<head>
    ...
    <title> Ruang Azzara| Rumah Sakit Islam Surabaya</title>
    ...
    <aside class="sidebar sidebar-default sidebar-white sidebar-base navs-rounded-all ">
        ...
        <div class="sidebar-body pt-0 data-scrollbar">
            <div class="sidebar-list">
                <!-- Sidebar Menu Start -->
                    @include('KBarang.template.sidebar')
                <!-- Sidebar Menu End -->
            </div>
        </div>
                ...
                <div class="container-fluid navbar-inner">
                    ...
                    <form  method="get">
                        <div class="input-group search-input">
                            ...
                            <input type="search" class="form-control" placeholder="Search..."name="search" autofocus value="{{$search}}">
                        </div>
                    </form>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="flex-wrap d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    <a href="{{ route('kode.create') }}" class="btn btn-link btn-soft-light">
