@extends('barang.template.layout_success')
            ...
            <div class="row justify-content-center">
                <div class="text-center col-7">
                    <h5 class="text-center purple-text">
                        Kamu Telah berhasil Menambahkan data !!<a href="{{route('barang.index')}}" class="text-underline">Kembali Ke halaman sebelumnya</a>
                    </h5>
                </div>
            </div>
        </div>
