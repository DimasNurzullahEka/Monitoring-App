<div class="sidebar-list">
    ...
    <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
        ...
        <li class="nav-item ">
            <a class="nav-link active" data-bs-toggle="collapse" href="#sidebar-special" role="button"
                ...
                <span class="item-name">Ruang Azzara</span>
                <i class="right-icon">
            ...
            <ul class="sub-nav collapse" id="sidebar-special" data-bs-parent="#sidebar-menu">
                ...
                <li class="nav-item ">
                    <a class="nav-link active" href="{{route('lokasi.index')}}">
                        <i class="icon">
                            <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                viewBox="0 0 24 24" fill="currentColor">
                                <g>
                        ...
                        <span class="item-name">Lokasi</span>
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link " href="{{route('kode.index')}}">
                        <i class="icon">
                            <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                viewBox="0 0 24 24" fill="currentColor">
                                <g>
                        ...
                        <span class="item-name">Kode</span>
                    </a>
                </li>
            </ul>
        </li>
