...
<head>
    ...
    <title>Ruang Azzara | Rumah Sakit Jemursari Surabaya</title>
                ...
                <div class="container-fluid navbar-inner">
                    ...
                    <form method="GET">
                        <div class="input-group search-input">
                            ...
                            <input type="search" name="search" class="form-control" placeholder="Search..." autofocus value="{{ $search }}">
                        </div>
                    </form>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="flex-wrap d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    <a href="{{ route('type.create') }}" class="btn btn-link btn-soft-light">
