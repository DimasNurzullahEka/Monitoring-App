...
@section('conten_formTambahTipe')
    <form id="form-wizard1" method="POST" action="{{ route('type.update', $type->id) }}" class="mt-3 text-center">
        @csrf
        @method('PUT')
        <ul id="top-tab-list" class="p-0 row list-inline">
            <li class="mb-2 col-lg-3 col-md-6 text-start active" id="account">
                <a href="javascript:void();">
                    ...
                    <span class="dark-wizard">Edit Type</span>
                </a>
            </li>
        ...
        <fieldset>
            <div class="form-card text-start">
                <div class="row">
                    <div class="col-7">
                        <h3 class="mb-4">Edit Type Information:</h3>
                    </div>
                    <div class="col-5">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="id" value="{{ old('id', $type->id) }}" required />
                            @if ($errors->has('id'))
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="nama_type" placeholder="Type" value="{{ old('nama_type', $type->nama_type) }}" required />
